#!/usr/bin/env python3
"""
Cabin Cleanliness Classification Model
Trains a TensorFlow/Keras CNN to classify cabin photos as:
- Clean: Cabin ready for passengers
- Needs_Attention: Requires minor cleaning
- Dirty: Requires immediate cleaning
...
def train_cabin_cleanliness(data_root, epochs=20, batch_size=16, learning_rate=0.001):
    """Train cabin cleanliness model."""
    
    print("=" * 70)
    print("🛫 CABIN CLEANLINESS CLASSIFICATION MODEL")
    print("=" * 70)
    ...
    model_path = os.path.join(model_dir, f"cabin_cleanliness_model_{timestamp}.keras")
    ...
    plot_path = os.path.join(model_dir, f"cabin_cleanliness_history_{timestamp}.png")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train cabin cleanliness model")
    parser.add_argument("--data-root", type=str, 
                       default=r"c:\Users\achre\Downloads\Esprit\DL\Ailines project\08_CNN\data\cabin_cleanliness",
