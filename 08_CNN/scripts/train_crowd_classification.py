#!/usr/bin/env python3
"""
Crowd Analytics Classification Model
Trains a CNN to classify airport crowd levels as:
- low_crowd: Few passengers at boarding gate
- high_crowd: Many passengers, high queue density

Useful for smart gate allocation and queue management (SDG 9).
...
def train_crowd_classification(data_root, epochs=20, batch_size=16, learning_rate=0.001):
    """Train crowd classification model."""
    
    print("=" * 70)
    print("👥 CROWD ANALYTICS CLASSIFICATION MODEL")
    print("=" * 70)
    ...
    model_path = os.path.join(model_dir, f"crowd_classification_model_{timestamp}.keras")
    ...
    plot_path = os.path.join(model_dir, f"crowd_classification_history_{timestamp}.png")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train crowd classification model")
    parser.add_argument("--data-root", type=str,
                       default=r"c:\Users\achre\Downloads\Esprit\DL\Ailines project\08_CNN\data\crowd",
