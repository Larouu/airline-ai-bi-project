...
This data package contains the data that powers the chart ["Annual CO₂ emissions from aviation"](https://ourworldindata.org/grapher/annual-co-emissions-from-aviation?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on April 24, 2026.
